...
def keyword_movie_search_titles(searched_query: str, movies_data: dict, case_insensitive=False, should_remove_punctuation=True, should_remove_stopwords=True, should_stem=True) -> list[dict]:
